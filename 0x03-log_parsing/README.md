...
1. Total File Size: `File size: <total size>`<br>
2. where `<total size>` is the sum of all previous `<file size>` (see input format above)<br>
3. Number of Lines by Status Code:<br>
...
NB: In this sample, you will have random value - it’s normal to not have the same output as this one.<br>
```
